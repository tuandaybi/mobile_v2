...
// Mở public các API đọc/ghi, chỉ giữ Bearer cho upload file (định nghĩa bên dưới)
// Profile
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    // Admin -> App updates (chỉ route upload giữ bảo vệ token)
